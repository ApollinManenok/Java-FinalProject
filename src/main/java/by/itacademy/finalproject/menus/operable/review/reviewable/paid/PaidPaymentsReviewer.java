...
public class PaidPaymentsReviewer implements Reviewable<PaidInfo> {
    ...
    private void fill(Group group, List<PaidInfo> infos) {
        for (Student student : group.getStudents()) {
            ...
            if (info.getCurrent() != null && info.getPrevious() != null)
                infos.add(info);
        }
    }
    ...
    @Override
    public String typo() {
        return "Print resent payments without debts";
    }
}
